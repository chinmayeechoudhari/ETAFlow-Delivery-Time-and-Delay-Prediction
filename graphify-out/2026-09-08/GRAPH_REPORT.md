...
## Corpus Check
- 7 files · ~34,826 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 108 nodes · 163 edges · 16 communities (7 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b42c817c`
...
4. `main()` - 6 edges
5. `create_dataset_metadata()` - 5 edges
6. `validate_dataset()` - 5 edges
7. `20. Categorized Recommendations & Next Steps` - 4 edges
8. `vectorized_haversine()` - 4 edges
9. `create_data_dictionary()` - 4 edges
10. `9. Target Variable Audit (Regression & Classification)` - 3 edges
...
## Knowledge Gaps
- **27 isolated node(s):** `1. Executive Summary`, `2. Dataset Overview`, `3. Audit Methodology`, `4. Schema & Structural Integrity`, `5. Missing-Value Characterization` (+22 more)
...
- **What connects `1. Executive Summary`, `2. Dataset Overview`, `3. Audit Methodology` to the rest of the system?**
